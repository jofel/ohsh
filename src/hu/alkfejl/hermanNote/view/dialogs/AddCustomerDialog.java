...
public class AddCustomerDialog extends JDialog implements ActionListener {
    ...
    public AddCustomerDialog(BookShopGUI gui, boolean modal) {
        ...
        // A dialógus megfelelő méretének beállítása (a tartalmazott elemek alapján)
        pack();
    ...
    private JPanel createSettingPanel() {
        ...
        // Az első sorban egy név címke és egy szövegmező lesz
        ...
        // A gender_panelre jobbra zártan egymás után pakolhatunk vezérlőket
        ...
        // A female-male-ből csak egy választható ki ezért egy ButtonGroupba rakjuk őket
        ...
        // ellenkező esetben a textfield-ek is aránytalanul magasabbak lesznek
        // mivel GridLayout-unk van, ahol minden cella egyforma méretű
    ...
    public void actionPerformed(ActionEvent e) {
        if (okButton == e.getSource()) {
            ...
            // cancel esetén egyszerűen bezárjuk az ablakot
            setVisible(false);
        }
    }
